...
var createCards = function() {
  ...
  console.log("click should work, will run function createCards")
...
var isTwoCards = function() {
  ...
  console.log("i'm in the click handler")
  var i = 0;

while (i < 2) {
  if(cardsInPlay[i] == "queen"){
  this.innerHTML = '<img id="queen" class="flippedcard" src="queen-of-diamonds.png" alt="queen-of-hearts" />';
    }

 if(cardsInPlay[i] == "king"){
     this.innerHTML = '<img id="king" class="flippedcard" src="king-of-diamonds.png" alt="king-of-hearts" />';
    }
    i++;
    }
...
console.log("should be in isMatch")
    var match = false;
